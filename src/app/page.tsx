        ...
        <>
            <div className="w-screen bg-gradient-to-l from-cyan-950 to-black h-screen pt-5 flex flex-col items-center justify-start  text-white">
                ...
                <div className="mt-5 flex flex-col gap-4">
                    <input type="text" className="w-72 rounded-md md:min-w-96 h-10  p-2 text-black placeholder:text-black" placeholder="Sequencia 1" value={seq1} onChange={handleSeq1Change} />
                    <input type="text" className="w-72 rounded-md md:min-w-96 h-10  p-2 text-black placeholder:text-black" placeholder="Sequencia 2" value={seq2} onChange={handleSeq2Change} />
                </div>
                ...
                <div className="text-[#ededed] cursor-default grid grid-cols-1 md:grid-cols-2 pt-10 max-w-xl md:max-w-none px-5 md:px-10 md:py-32 bg-[#0e0e0e] w-full h-auto">
                    ...
                    <div className="col-span-2 md:col-span-1">
                        <h1 className="font-bold text-white">Introdução</h1>
                    ...
                    <div className="col-span-2 grid sm:grid-cols-2 md:grid-cols-3 gap-3 pt-5 z-3">
                        ...
                        <a href="https://www.ebi.ac.uk/pdbe/" target="blank">
                            <div className="group border border-[#0e0e0e] h-auto p-2 col-span-1 hover:border hover:border-gray-500 rounded-lg transition-all cursor-pointer">
                                ...
                                <p className="mt-5 text-sm">Banco de dados de proteínas que contém informações estruturais sobre proteínas experimentais resolvidas por cristalografia de raios X, ressonância magnética nuclear e modelagem.</p>
                            </div>
                        </a>
                        <a href="https://www.uniprot.org/" target="blank">
                            <div className="group border border-[#0e0e0e] h-auto p-2 col-span-1 hover:border hover:border-gray-500 rounded-lg transition-all cursor-pointer">
                                ...
                                <p className="mt-5 text-sm">Uma base de dados abrangente de proteínas e informações funcionais, que fornece acesso a dados sobre a função de proteínas, sua localização, expressão e muito mais.</p>
                            </div>
                        </a>
                        <a href="https://www.ensembl.org/index.html" target="blank">
                            <div className="group border border-[#0e0e0e] h-auto p-2 col-span-1 hover:border hover:border-gray-500 rounded-lg transition-all cursor-pointer">
                                ...
                                <p className="mt-5 text-sm">Um projeto que visa fornecer genomas anotados de várias espécies, com uma ênfase particular em genomas de vertebrados.</p>
                            </div>
                        </a>
                        <a href="https://www.ebi.ac.uk/interpro/" target="blank">
                            <div className="group border border-[#0e0e0e] h-auto p-2 col-span-1 hover:border hover:border-gray-500 rounded-lg transition-all cursor-pointer">
                                ...
                                <p className="mt-5 text-sm">InterPro é uma base de dados que fornece classificações integradas de proteínas, agrupando proteínas em famílias e predizendo domínios e sítios de ligação a partir de suas sequências. Utilizando várias ferramentas e recursos de bioinformática, InterPro ajuda na análise funcional e estrutural de proteínas, facilitando a compreensão de suas funções biológicas e interações.</p>
                            </div>
                        </a>
                    </div>
                </div>
